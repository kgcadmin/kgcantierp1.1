...
const Sidebar = ({ isVisible, onClose }) => {
  ...
  const navItems = [
    ...
    { name: 'SIS (Students)', path: '/students', icon: <GraduationCap size={20} /> },
    { name: 'Faculty', path: '/faculty', icon: <UserCheck size={20} /> },
    ...
    { name: 'Fees', path: '/fees', icon: <Wallet size={20} /> },
    ...
    { name: 'Attendance', path: '/attendance', icon: <CheckCircle2 size={20} /> },
